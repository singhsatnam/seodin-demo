...
import net.ptidej.seodin.config.audit.AuditEventConverter;
import net.ptidej.seodin.domain.PersistentAuditEvent;
...
import static net.ptidej.seodin.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
