...
import { TestCaseDialogComponent } from '../../../../../../main/webapp/app/entities/test-case/test-case-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('TestCase Management Dialog Component', () => {
        let comp: TestCaseDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(TestCaseDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'testCaseListModification', content: 'OK'});
